        ...
        <table class="table table-sm table-striped">
            ...
            <c:forEach var="taskInstance" items="${tarefas}">
                <tr class="count">
                    ...
                    <td align="right"
                        title="${f:formatarDDMMYY(taskInstance.instanciaDeProcedimento.dtInicioDaTarefa)}">${f:tempoRelativo(taskInstance.instanciaDeProcedimento.dtInicioDaTarefa)}</td>
                    <td align="right"
                        title="${f:formatarDDMMYY(taskInstance.instanciaDeProcedimento.hisDtIni)}">${f:tempoRelativo(taskInstance.instanciaDeProcedimento.hisDtIni)}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
